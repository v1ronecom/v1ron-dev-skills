...
inputs:
  task:
    type: string
    required: true
    description: "Operation to perform: create, extract_text, merge, split, rotate, watermark, encrypt, decrypt"
  content:
    type: string
    required: false
    description: "Topic or content for PDF creation (used when task=create)"
  file_url:
    type: string
    required: false
  ...
  file_urls:
    type: string
    required: false
    description: "Comma-separated URLs of PDF files to merge (used when task=merge)"
  pages:
    type: string
    required: false
    description: "Page range to extract or rotate, e.g. '1-5' or '2,4,6'"
  password:
    type: string
    required: false
    description: "Password for encrypting or decrypting a PDF"
  options:
    type: string
    required: false
    description: "JSON string with extra options, e.g. {\"rotation\": 90, \"watermark_text\": \"CONFIDENTIAL\"}"
